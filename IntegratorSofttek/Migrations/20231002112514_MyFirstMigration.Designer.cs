...
namespace IntegratorSofttek.Migrations
{
    ...
    [Migration("20231002112514_MyFirstMigration")]
            ...
            modelBuilder.Entity("IntegratorSofttek.Entities.Work", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Cost = 1000.0,
                            Date = new DateTime(2023, 10, 2, 8, 25, 14, 679, DateTimeKind.Local).AddTicks(8479),
                            HourlyRate = 25.0,
                            HoursQuantity = 40,
                            IsDeleted = false,
                            ProjectId = 1,
                        ...
                        new
                        {
                            Id = 2,
                            Cost = 900.0,
                            Date = new DateTime(2023, 10, 1, 8, 25, 14, 679, DateTimeKind.Local).AddTicks(8490),
                            HourlyRate = 30.0,
                            HoursQuantity = 30,
                            IsDeleted = false,
                            ProjectId = 2,
                        ...
                        new
                        {
                            Id = 3,
                            Cost = 1000.0,
                            Date = new DateTime(2023, 9, 30, 8, 25, 14, 679, DateTimeKind.Local).AddTicks(8494),
                            HourlyRate = 20.0,
                            HoursQuantity = 50,
                            IsDeleted = false,
                            ProjectId = 1,
                        ...
                        new
                        {
                            Id = 4,
                            Cost = 980.0,
                            Date = new DateTime(2023, 9, 29, 8, 25, 14, 679, DateTimeKind.Local).AddTicks(8495),
                            HourlyRate = 28.0,
                            HoursQuantity = 35,
                            IsDeleted = false,
                            ProjectId = 2,
                        ...
                        new
                        {
                            Id = 5,
                            Cost = 990.0,
                            Date = new DateTime(2023, 9, 28, 8, 25, 14, 679, DateTimeKind.Local).AddTicks(8496),
                            HourlyRate = 22.0,
                            HoursQuantity = 45,
                            IsDeleted = false,
                            ProjectId = 3,
