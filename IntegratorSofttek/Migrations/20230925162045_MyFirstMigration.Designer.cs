...
namespace IntegratorSofttek.Migrations
{
    ...
    [Migration("20230925162045_MyFirstMigration")]
            ...
            modelBuilder.Entity("IntegratorSofttek.Entities.Work", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Cost = 1000.0,
                            Date = new DateTime(2023, 9, 25, 13, 20, 45, 40, DateTimeKind.Local).AddTicks(6443),
                            HourlyRate = 25.0,
                            HoursQuantity = 40,
                            IsDeleted = false,
                            ProjectId = 1,
                        ...
                        new
                        {
                            Id = 2,
                            Cost = 900.0,
                            Date = new DateTime(2023, 9, 24, 13, 20, 45, 40, DateTimeKind.Local).AddTicks(6458),
                            HourlyRate = 30.0,
                            HoursQuantity = 30,
                            IsDeleted = false,
                            ProjectId = 2,
                        ...
                        new
                        {
                            Id = 3,
                            Cost = 1000.0,
                            Date = new DateTime(2023, 9, 23, 13, 20, 45, 40, DateTimeKind.Local).AddTicks(6463),
                            HourlyRate = 20.0,
                            HoursQuantity = 50,
                            IsDeleted = false,
                            ProjectId = 1,
                        ...
                        new
                        {
                            Id = 4,
                            Cost = 980.0,
                            Date = new DateTime(2023, 9, 22, 13, 20, 45, 40, DateTimeKind.Local).AddTicks(6464),
                            HourlyRate = 28.0,
                            HoursQuantity = 35,
                            IsDeleted = false,
                            ProjectId = 2,
                        ...
                        new
                        {
                            Id = 5,
                            Cost = 990.0,
                            Date = new DateTime(2023, 9, 21, 13, 20, 45, 40, DateTimeKind.Local).AddTicks(6465),
                            HourlyRate = 22.0,
                            HoursQuantity = 45,
                            IsDeleted = false,
                            ProjectId = 3,
